...
`research/state-constrained-architecture/`; exploratory predecessor notes remain
in that research area's `working-notes/` directory.

The Time Entry application applies these ideas through its own requirements,
state model, and architecture under `content/projects/time-entry/`.
